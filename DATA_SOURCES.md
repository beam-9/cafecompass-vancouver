...
| Kaggle Yelp Dataset mirror | https://www.kaggle.com/datasets/yelp-dataset/yelp-dataset | Alternative download location for the Yelp Open Dataset. | Kaggle account/API if downloading through Kaggle. | Optional. | Same usage restrictions as the dataset source. Do not commit raw files. |
