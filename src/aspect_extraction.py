        ...
        out = pd.DataFrame(
            {
                ...
                "business_id": df[place_col] if place_col == "business_id" and place_col in df.columns else None,
                "place_id": df[place_col] if place_col == "place_id" and place_col in df.columns else None,
                "text": df[text_col],
